...
const Navbar = () => {
  ...
  const companyNavItems = [
    { path: "/company/portal", title: "Company Portal" },
    { path: "/company/my-jobs", title: "Manage Jobs" },
    { path: "/company/post-job", title: "Post A Job" },
  ];
        ...
        <div className="text-base text-primary font-medium space-x-5 hidden lg:block">
          {user ? (
            ...
            <>
              ...
              <Link to="/company/login" className="py-2 px-5 border rounded">
                Company Login
              </Link>
              <Link
                to="/sign-up"
